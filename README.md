...
The REST API documentation can be found on [docs.parsecapi.com](https://docs.parsecapi.com). The full API of this library can be found in [api.md](api.md). For the markets endpoint, the `scope` parameter controls query mode (`list`, `market`, `market_batch`, `event`).
