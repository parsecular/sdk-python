...
from ..types import websocket_usage_params
...
from ..types.websocket_usage_response import WebsocketUsageResponse
...
class WebsocketResource(SyncAPIResource):
    ...
    def usage(
        ...
        *,
        ...
        Args:
          limit: Max number of markets/customers returned (default 20; server clamps to 1..=100).

          scope: "self" (default) or "global" (admin only).
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    websocket_usage_params.WebsocketUsageParams,
                ),
            ),
            cast_to=WebsocketUsageResponse,
        )
