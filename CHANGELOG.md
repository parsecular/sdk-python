...
* **api:** api update ([1df78b4](https://github.com/parsecular/sdk-python/commit/1df78b4989a9dd9aead5f33a2de3cfd15b98de8b))


### Chores

* **ci:** skip uploading artifacts on stainless-internal branches ([c53f83f](https://github.com/parsecular/sdk-python/commit/c53f83ffd0a1390351f9aa80f395b3e310583ff5))

## 0.12.0 (2026-03-05)

Full Changelog: [v0.11.1...v0.12.0](https://github.com/parsecular/sdk-python/compare/v0.11.1...v0.12.0)

### Features

* **api:** api update ([62662c8](https://github.com/parsecular/sdk-python/commit/62662c898889fbae1bed99785d669d1634e0fde6))
